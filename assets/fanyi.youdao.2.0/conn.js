...
(function () {
  ...
  const cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g; const escapable = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g; let gap; let indent; const meta = { '\b': '\\b', '\t': '\\t', '\n': '\\n', '\f': '\\f', '\r': '\\r', '"': '\\"', '\\': '\\\\' }; let rep
  ...
  function str (key, holder) {
    let i; let k; let v; let length; const mind = gap; let partial; let value = holder[key]
...
window.onload = function () {
   ...
   */
  const bind = function (object, eventName, callback) {
    if (!callback) {
      return
    }
  ...
  const storage = function (key, value) {
    /**
       ...
       * @param value
       */
    const html5LocalStorage = function (key, value) {
    ...
    /**
       ...
       * @param value
       */
    const userdata = function (key, value) {
  ...
  function createXMLHttpObject () {
    ...
    let xhr = false
    for (let i = 0; i < XHRFactory.length; i++) {
      try {
        xhr = XHRFactory[i]()
      } catch (e) {
        continue
  ...
  const handleMessage = (function () {
    /**
       ...
       * @param request
       */
    const initData = function (request) {
      let dataArray = request.data; const data = {}
    ...
    const handlers = {
      ...
      localStorage: function (request) {
        const data = initData(request)
        const result = decodeURIComponent(storage(data.key, data.value))
        Response.sendMessage({
          handler: BACKFLAG,
          response: result,
          index: request.index
